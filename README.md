...
- vaadintestlll-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadintestlll-ui: main application module, development time
- vaadintestlll-production: module that produces a production mode WAR for deployment
