...
public class Menu extends CssLayout {
    ...
    public Menu(Navigator navigator) {
        ...
        final VerticalLayout toplabels = new VerticalLayout();
        toplabels.setMargin(false);
        toplabels.setSpacing(false);

        Label title = new Label("GeoDoor");
        title.addStyleName("logo_label");
        title.setSizeUndefined();

        Label title2 = new Label("Server");
        title2.addStyleName("logo_label");
        title.setSizeUndefined();

        toplabels.addComponents(title, title2);

        Image image = new Image(null, new ThemeResource("img/menu-icon.png"));
        image.setStyleName("logo");
        top.addComponent(image);
        top.addComponent(toplabels);
